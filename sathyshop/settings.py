...
WSGI_APPLICATION = 'sathyshop.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'websaathy@gmail.com'  # To be updated by client
EMAIL_HOST_PASSWORD = 'hwnkmuqodualvwdh'   # To be updated by client
EMAIL_USE_TLS = True